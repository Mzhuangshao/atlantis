...
execute at @e[tag=atlantis_room] run fill ~12 240 ~12 ~-12 240 ~-12 light[level=0,waterlogged=true]
execute at @e[tag=atlantis_room] run fill ~12 241 ~12 ~-12 280 ~-12 air
