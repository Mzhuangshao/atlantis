execute as @e[tag=atlantis_local,tag=no_saplings] run place structure atlantis:atlantis_room_no_saplings ~-5 ~ ~-5
execute as @e[tag=atlantis_local,tag=!no_saplings] run place structure atlantis:atlantis_room ~-5 ~ ~-5
