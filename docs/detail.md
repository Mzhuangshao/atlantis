...
- 为下文内容选择阅读语言 : → [[以简体中文阅读](https://github.com/Mzhuangshao/atlantis/blob/main/README.md)]   [[以繁體中文閲覽](https://github.com/Mzhuangshao/atlantis/blob/main/README_zh_tw.md)]   [[Read in English](https://github.com/Mzhuangshao/atlantis/blob/main/README_en_us.md)]
<!-- - 为下文内容选择阅读语言 : → [[以简体中文阅读](.\README.md)]   [[以繁體中文閲覽](.\docs\README_zh_tw.md)]   [[Read in English](.\docs\README_en_us.md)] -->
...
| -------------- | ---------------------------------------------------------------------- | --------------------------------------------------------- |
| 普通木桶       | 金粒、铁粒                                                             |                                                           |
| 地图木桶       | *动物圈地图*、空地图、指南针、纸                                       | 金粒、铁粒、<ins>*收纳袋（在1.21.2及更高版本出现）*</ins> |
| 杂物木桶       | 小麦、胡萝卜、马铃薯、毒马铃薯、锁链装备、箭矢、玻璃瓶、骨头、骷髅头颅 | 金粒、铁粒、<ins>*收纳袋（在1.21.2及更高版本出现）*</ins> |
| 繁花森林木桶   | 常见的花卉                                                             | 金粒、铁粒、<ins>*收纳袋（在1.21.2及更高版本出现）*</ins> |
| 向日葵平原木桶 | 向日葵                                                                 | 金粒、铁粒、<ins>*收纳袋（在1.21.2及更高版本出现）*</ins> |
| 丛林群系木桶   | 丛林树苗、可可豆                                                       | 金粒、铁粒、<ins>*收纳袋（在1.21.2及更高版本出现）*</ins> |
| 针叶林群系木桶 | 甜浆果、云杉树苗、兔子皮                                               | 金粒、铁粒、<ins>*收纳袋（在1.21.2及更高版本出现）*</ins> |
| 海洋群系木桶   | 海带、海晶碎片、海晶砂粒、*海洋之心*                                   | 金粒、铁粒、<ins>*收纳袋（在1.21.2及更高版本出现）*</ins> |

### ⚙️ 其它内容

- 由于海面上过于冰冷，以至于**玩家在海面以上的行动十分困难**。
  - 拥有持续性抗性提升II或潮涌能量的效果可以缓解。
- 定制的进度系统（持续更新中，**欢迎提供更改意见**）；
- 用海晶碎片、海晶砂粒、鹦鹉螺壳、金锭搭配海绵可以合成更多的海绵，此合成表在获得海绵后会自动解锁；
- 玩家手动种植的苍白橡树有概率带有<ins>*嘎枝之心（在1.21.4及更高版本出现）*</ins>。

### 🐱 生物

- 猪灵可以交易出下界合金升级模板、恼鬼盔甲纹饰模板、眼眸盔甲纹饰模板；
- 玩家被玩家抡死会掉落**玩家头颅**；
- 河流群系刷新溺尸的几率比普通世界更低。
...
| 女巫小屋 (Swamp Hut)            | 可以在沼泽与红树林沼泽的**地下**生成 |
...
- 单独定位特定类型的生物圈可以使用指令`/locate structure atlantis:animal_dome/[类型]`，例如`/locate structure atlantis:animal_dome/desert`可以查找沙漠类型的动物圈。
...
- 在bilibili发布的视频可以附上概念PV的BV号`BV11hSyYPEkc   https://www.bilibili.com/video/BV11hSyYPEkc`
